...
const MASTER_BIN_URL = `https://cdn.prinopix.com/${eventName}/Master_Bin/master.bin`;

const MASTER_JSON_URL = `https://cdn.prinopix.com/${eventName}/Master_Json/master.json`;
