...
const MASTER_BIN_URL = `https://cdn.prinopix.com/production/photo_hosting/${eventName}/master_bin/master.bin`;

const MASTER_JSON_URL = `https://cdn.prinopix.com/production/photo_hosting/${eventName}/master_json/master.json`;
